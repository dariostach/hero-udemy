...
<div class="form-group">
    ...
    <input type="name" class="form-control" id="name" name="name" @isset($enemy) value="{{ $enemy->name }}" @endisset placeholder="Ingrese un nombre" required>        
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="number" class="form-control" id="coins" name="coins" @isset($enemy) value="{{ $enemy->coins }}" @endisset placeholder="Ingrese el precio" required>        
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <input type="file" id="img_path" name="img_path" class="file">
</div>